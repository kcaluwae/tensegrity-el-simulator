...
class Visualization(object):
	...
	def init_plot(self):
		...
		for i in range(self.simulator.B):
			...
			self.bars_plot.append(self.ax.plot(nodes[(_from,_to),0],nodes[(_from,_to),1],nodes[(_from,_to),2],c='r')[0])
		self.springs_plot = []
		...
		#axes properties
		self.ax.set_xlim3d([-4., 4.])
		self.ax.set_xlabel('X')
		self.ax.set_ylim3d([-4., 4.])
		self.ax.set_ylabel('Y')
		self.ax.set_zlim3d([-4, 4])
